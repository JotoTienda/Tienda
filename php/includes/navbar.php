			...
			<div class="col-lg-12 d-block">
				<div class="row d-flex">
					...
					<div class="
									...
									text-lg-right
								">
						<span class="text">Reparto en 1 dia o recogida en local al
							momento</span>
					</div>
				</div>
			</div>
...
<nav class="
	...
	" id="ftco-navbar">
	<div class="container">
		<a class="navbar-brand" href="../../index.html"><img src="../../images/logo/logo_transparent_background.png" alt="" style="width: 75px; height: 60px" /></a>
		...
		<div class="collapse navbar-collapse" id="ftco-nav">
			<ul class="navbar-nav ml-auto">
				...
				<li class="nav-item cta cta-colored">
					<a href="../pages/cart.php" class="nav-link" id="logo_cart"><span class="icon-shopping_cart"></span>[0]</a>
				</li>
			</ul>
		</div>
	</div>
