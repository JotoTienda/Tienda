...
apt-get update
sudo apt-get update
git config --global user.name "ServidorJTomas"
git config --global user.email jototienda@gmail.com
git add .
ls
git status
git add .
...
git status
git add .
git commit -m "JT edit total_carrito"
git push
git pull
git pull
git push
